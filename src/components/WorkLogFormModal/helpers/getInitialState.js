...
export const getInitialState = (data, date, isWorkLogTimerDisplayed) => {
  ...
  return {
    formData: {
      ...
      isHomeOffice: (data && data.isHomeOffice) || false,
      plannedEndHour: (data && data.plannedEndHour) || null,
      plannedEndMinute: (data && data.plannedEndMinute) || null,
      plannedStartHour: (data && data.plannedStartHour) || null,
      plannedStartMinute: (data && data.plannedStartMinute) || null,
