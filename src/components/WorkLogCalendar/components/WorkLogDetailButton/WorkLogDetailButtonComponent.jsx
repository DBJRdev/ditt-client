...
const WorkLogDetailButtonComponent = (props) => {
  const {
    currentDate,
    daysOfCurrentMonth,
    fetchWorkMonth,
...
WorkLogDetailButtonComponent.defaultProps = {
  isInSupervisorMode: false,
  onDuplicate: null,
  uid: null,
};

WorkLogDetailButtonComponent.propTypes = {
...
export default withTranslation()(WorkLogDetailButtonComponent);
