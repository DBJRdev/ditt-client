...
export default (state, action) => {
  ...
  if (type === actionTypes.SAVE_CONFIG_REQUEST) {
    return state
      .setIn(['config', 'isPosting'], true)
      .setIn(['config', 'isPostingFailure'], false);
  }
  ...
  if (type === actionTypes.SAVE_CONFIG_FAILURE) {
    return state
      .setIn(['config', 'isPosting'], false)
      .setIn(['config', 'isPostingFailure'], true);
  }
